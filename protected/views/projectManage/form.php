	...
	<div class="box box-info">
		<div class="box-body">
			...
			<div class="form-group">
                ...
                <div class="col-lg-4">
                    <?php
                    echo $form->dropDownList($model, 'assign_user',FunctionSearch::getAssignUserList($model->menu_id,false),
                        array('readonly'=>($model->scenario=='view'),'id'=>'assign_user','multiple'=>'multiple','disabled'=>'disabled')
                    ); ?>
                </div>
			</div>
			<div class="form-group">
