...
<section class="content">
	...
	<div class="btn-group" role="group">
        <?php echo TbHtml::button('<span class="fa fa-search"></span> '.Yii::t('freed','Enquiry'), array(
            'submit'=>Yii::app()->createUrl('statisticProAll/view')));
        ?>
	</div>
	...
	<div class="box box-info">
		<div class="box-body">
            ...
            <div class="form-group">
                <?php echo $form->labelEx($model,'menu_id',array('class'=>"col-sm-2 control-label")); ?>
                <div class="col-sm-2">
                    <?php echo $form->dropDownList($model, 'menu_id',FunctionSearch::getMenuAll(),
                        array('readonly'=>false,'id'=>'menu_id','empty'=>Yii::t("freed","-- All --"))
                    ); ?>
                </div>
            </div>
...
$js = Script::genDatePicker(array(
    'StatisticProAllForm_search_start_date',
    'StatisticProAllForm_search_end_date'
));
