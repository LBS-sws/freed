<?php
$this->pageTitle=Yii::app()->name . ' - StatisticProAll Form';
?>

<?php $form=$this->beginWidget('TbActiveForm', array(
'id'=>'StatisticProAll-form',
...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','Project analyze'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('statisticProAll/index')));
		?>
	</div>
            <div class="btn-group pull-right" role="group">
                <?php echo TbHtml::button('<span class="fa fa-download"></span> '.Yii::t('dialog','Download'), array(
                    'submit'=>Yii::app()->createUrl('statisticProAll/downExcel')));
                ?>
            </div>
	</div></div>
                ...
                <div class="box-body" >
                    <div class="col-lg-5">
                        ...
                        <div class="form-group">
                            <?php echo $form->labelEx($model,'menu_id',array('class'=>"col-lg-5 control-label")); ?>
                            <div class="col-lg-5">
                                <?php echo $form->dropDownList($model, 'menu_id',FunctionSearch::getMenuAll(),
                                    array('readonly'=>true,'id'=>'menu_id','empty'=>Yii::t("freed","-- All --"))
                                ); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <?php echo $form->hiddenField($model, 'total_all'); ?>
                            <?php echo $form->hiddenField($model, 'total_finish'); ?>
                            <?php echo $form->hiddenField($model, 'total_unfinished'); ?>
                    ...
                    <div class="col-lg-12" style="padding-top: 15px;">
                        <div class="col-lg-2">
                            <?php
                            echo "<strong>".Yii::t("freed","project total")."：</strong>";
                            echo "<span>".$model->total_all."</span>";
                            ?>
                        </div>
                        <div class="col-lg-2">
                            <?php
                            echo "<strong>".Yii::t("freed","finish total")."：</strong>";
                            echo "<span>".$model->total_finish."</span>";
                            ?>
                        </div>
                        <div class="col-lg-2">
                            <?php
                            echo "<strong>".Yii::t("freed","unfinished total")."：</strong>";
                            echo "<span>".$model->total_unfinished."</span>";
                            ?>
                        </div>
                    </div>
                    <div class="col-lg-12" style="padding-top: 15px;">
                        <div class="row panel panel-default" style="border-color: #333">
                            ...
                            <div class="panel-heading">
                                <h3 style="margin-top:10px;">
                                    <?php echo Yii::t('app','Project analyze'); ?>
                            ...
                            <div class="table-responsive">
                                <?php echo $model->statisticProAllHtml();?>
                            </div>
                        </div>
                    </div>
                </div>
...
$js="
    $('.click-th').click(function(){
        ...
        if($(this).hasClass('active')){
            ...
            $('#statisticProAll>thead>tr').eq(0).children().slice(startNum,endNum).each(function(){
                var width = $(this).data('width')+'px';
                $(this).width(width);
            });
            $('#statisticProAll>thead>tr').eq(2).children().slice(startNum-contNum,endNum-contNum).each(function(){
                $(this).children('span').text($(this).data('text'));
            });
            $('#statisticProAll>tbody>tr').each(function(){
...
";
$ajaxUrl = Yii::app()->createUrl('statisticProAll/ajaxDetail');
$js.= "
