        ...
        success: function(data) {
            if (data.length > 0) {
                data.forEach(function (arrayItem) {
                    $('#counter'+arrayItem.code).html('');
                    $('#span_top_'+arrayItem.code).remove();
                    if (arrayItem.count > 0) {
                        ...
                        var badge1 = '<span class="label '+arrayItem.color+'" id="span_top_'+arrayItem.code+'">'+arrayItem.count+'</span>';
