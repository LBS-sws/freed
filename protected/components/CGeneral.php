...
class CGeneral {
	...
	*/
    ...
    public static function getCityListWithDescendant() {
        $list = array(""=>"");
        $suffix = Yii::app()->params['envSuffix'];
        $sql = "select distinct b.code, b.name from security$suffix.sec_city a 
					left outer join security$suffix.sec_city b on b.code=a.region 
